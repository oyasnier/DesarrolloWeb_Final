...
<head>
    ...
    <title>Tarea Ejercicio 10</title>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-12 text-center">
            <h2>FORMULARIO TAREA EJERCICIO 26</h2>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <textarea class="form-control" placeholder="Describa brevemente sus antecedentes" Required></textarea>
    </div>
    ...
    <form name="subida-imagenes" type="POST" enctype="multipart/formdata" >
        <label for="subida-imagenes">Agregar una Imagen</label>
        <input type="image" name="imagen1" />
